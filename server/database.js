    ...
    query('SELECT MAX(id) id FROM games', function(err, results) {
        ...
        if (!id || id < 10e6) {
            return callback(null, {
                id: 10e6 - 1,
                hash: 'a1cfa8e28fc38999eaa888487a443bad50a65e0b910f649affa6718cfbfadb4a'
            });
        }
...
var endGameQuery =
  ...
  '), u AS (' +
  ' UPDATE users SET balance_duffs = balance_duffs + vals.bonus ' +
...
exports.getBankroll = function(callback) {
    query('SELECT (' +
            ...
            '(SELECT COALESCE(SUM(balance_duffs), 0) FROM users)) AS profit ',
...
exports.getGameHistory = function(callback) {
    ...
    query(sql, function(err, data) {
        ...
        data.rows.forEach(function(row) {
            // oldInfo is like: [{"username":"USER","bet":duffs, ,..}, ..]
